...
{
    public partial class resumo_neil : Form
    {
        public resumo_neil()
        {
            InitializeComponent();
        ...
        private void BtnCuriosidades_Click_1(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void BtnResumo_Click_1(object sender, EventArgs e)
        {
            this.Hide();
